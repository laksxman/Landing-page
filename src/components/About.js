...
const about = () => {
  return (
    <div className='bg-gradient-to-r from-indigo-300 via-purple-200 to-pink-300 inline-flex px-4 lg:px-64 w-screen mx-auto max-h-full justify-between py-24' id='about'>
...
<div className='block'>
    ...
    <button className='h-6 w-20 bg-fuchsia-600 text-sm text-center font-semibold'>Learn More</button>
</div>
